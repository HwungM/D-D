...
export async function generateNarrationFromService(
  openai: ChatClient,
...
export async function* generateNarrationStreamingFromService(
  openai: ChatClient,
  action: string,
  worldState: WorldState,
  worldBible: WorldBible,
...
export async function generateCoopNarrationFromService(
  openai: ChatClient,
  logAiCall: AiCallLogger,
