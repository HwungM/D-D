...

{
  ...
  "ambientEventSeeds": [
    ...
    "A strange omen or distant sign fitting this world's tone - one short sentence",
    "A scrap of news or rumor from elsewhere in the world, unrelated to the main plot - one short sentence",
    "Another ambient texture beat specific to this premise's factions or geography - one short sentence",
    "One more, distinct in flavor from the others above - one short sentence"
  ],
  "futureHookSeeds": [
