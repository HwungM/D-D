...
const ASSETS = [
  ...
  { file: 'scenes/dungeon-corridor.png', prompt: `${STYLE} A stone dungeon corridor stretching into darkness, torch sconces on the walls casting orange pools of light, damp stone floor, ancient carved reliefs on the walls, mysterious door at the end. Wide landscape format.` },
  ...
  { file: 'scenes/marketplace.png', prompt: `${STYLE} A bustling medieval fantasy marketplace at dawn, merchant stalls with colorful goods, cobblestone streets, half-timbered buildings, a fountain in the center, early morning fog. Wide landscape format.` },
  ...
  { file: 'scenes/mountain-pass.png', prompt: `${STYLE} A treacherous mountain pass at dusk, narrow stone path along a sheer cliff, stormy sky, distant peaks, torchlight from a watchtower far below. Wide landscape format.` },
  { file: 'scenes/harbor.png', prompt: `${STYLE} A dark fantasy harbor at night, fishing boats and a warship moored at weathered docks, lantern reflections in oily water, fog rolling in from the sea, a lighthouse in the distance. Wide landscape format.` },
  { file: 'scenes/crypt.png', prompt: `${STYLE} An ancient underground crypt, stone sarcophagi in alcoves, cobwebs, a single burning brazier, carved skull reliefs on the walls, a collapsed section revealing deeper darkness. Wide landscape format.` },
  { file: 'scenes/wizard-tower.png', prompt: `${STYLE} Interior of a wizard's tower laboratory, shelves of glowing vials and ancient tomes, a celestial orrery turning slowly, arcane diagrams on the floor, the night sky through a circular window. Wide landscape format.` },
  { file: 'scenes/battlefield.png', prompt: `${STYLE} The aftermath of a great battle on an open plain, broken weapons in muddy earth, ravens, smoke rising from distant fires, storm clouds rolling in, a single surviving banner. Wide landscape format.` },

  // Item Icons
  { file: 'items/sword-common.png', prompt: `${STYLE} Item icon: a plain iron longsword, simple crossguard, worn leather grip, slightly pitted blade. Small square icon, isolated on dark background.` },
  { file: 'items/sword-rare.png', prompt: `${STYLE} Item icon: an elegant silver longsword with a sapphire set in the crossguard, runes etched along the blade, soft blue glow. Small square icon, isolated on dark background.` },
  { file: 'items/sword-legendary.png', prompt: `${STYLE} Item icon: a legendary flaming greatsword, blade wreathed in controlled fire, ornate gold hilt with a dragon motif, ancient runes glowing orange. Small square icon, isolated on dark background.` },
  { file: 'items/staff-arcane.png', prompt: `${STYLE} Item icon: a gnarled wooden wizard staff topped with a crackling orb of purple arcane energy, carved sigils along the shaft. Small square icon, isolated on dark background.` },
  { file: 'items/dagger.png', prompt: `${STYLE} Item icon: a slim assassin's dagger, dark blade with a serrated edge, black wrapped handle, traces of poison on the tip. Small square icon, isolated on dark background.` },
  { file: 'items/bow.png', prompt: `${STYLE} Item icon: an elegant recurve bow of dark yew wood, silver-tipped limbs, with a quiver of black-feathered arrows. Small square icon, isolated on dark background.` },
  { file: 'items/axe.png', prompt: `${STYLE} Item icon: a brutal bearded battle-axe, notched blade, blood-stained, wrapped leather handle with iron studs. Small square icon, isolated on dark background.` },
  { file: 'items/armor-leather.png', prompt: `${STYLE} Item icon: a set of worn brown leather armor, reinforced with studs, a ranger's chest piece, well-maintained but battle-scarred. Small square icon, isolated on dark background.` },
  { file: 'items/armor-plate.png', prompt: `${STYLE} Item icon: gleaming full plate armor chest piece, etched with battle honors, deep scratches from combat, polished steel. Small square icon, isolated on dark background.` },
  { file: 'items/shield.png', prompt: `${STYLE} Item icon: a battered kite shield, iron boss in the center, a faded family crest barely visible, sword cuts along the rim. Small square icon, isolated on dark background.` },
  { file: 'items/potion-health.png', prompt: `${STYLE} Item icon: a small glass vial of glowing crimson liquid, corked with wax seal, warm inner light, a few bubbles rising. Small square icon, isolated on dark background.` },
  { file: 'items/potion-mana.png', prompt: `${STYLE} Item icon: a small glass vial of swirling cobalt blue liquid, silver stopper, faint arcane shimmer. Small square icon, isolated on dark background.` },
  { file: 'items/scroll.png', prompt: `${STYLE} Item icon: a rolled parchment scroll tied with a red ribbon, aged and yellowed, arcane glyphs visible on the exposed edge, wax seal broken. Small square icon, isolated on dark background.` },
  { file: 'items/gold-pouch.png', prompt: `${STYLE} Item icon: a leather coin pouch tied with cord, bulging with coins, a few gold coins spilling out. Small square icon, isolated on dark background.` },
  { file: 'items/key.png', prompt: `${STYLE} Item icon: an ornate iron key with a skull-shaped bow, ancient and heavy, engraved with a room number. Small square icon, isolated on dark background.` },
  { file: 'items/tome.png', prompt: `${STYLE} Item icon: a heavy leather-bound spellbook, iron clasp, arcane symbol embossed on the cover, pages edged in gold. Small square icon, isolated on dark background.` },
  { file: 'items/ring.png', prompt: `${STYLE} Item icon: a gold ring with a glowing green gemstone, fine filigree work, inscription on the inner band. Small square icon, isolated on dark background.` },
  { file: 'items/amulet.png', prompt: `${STYLE} Item icon: a silver amulet on a chain, a dark purple gemstone at center, strange carved symbols surrounding it, faint otherworldly glow. Small square icon, isolated on dark background.` },
  { file: 'items/boots.png', prompt: `${STYLE} Item icon: ranger's soft leather boots, dark brown, silent-soled, mud-stained from hard travel, reinforced toe and ankle. Small square icon, isolated on dark background.` },
  { file: 'items/cloak.png', prompt: `${STYLE} Item icon: a deep forest-green hooded cloak, clasped with a silver leaf brooch, edges slightly frayed, stained with travel. Small square icon, isolated on dark background.` },
];
...
async function generateAsset(asset, index, total) {
  ...
  if (fs.existsSync(outputPath)) {
    console.log(`[${index}/${total}] SKIP (exists): ${asset.file}`);
    return;
  }
  ...
  try {
    ...
    console.log(`[${index}/${total}] ✓ Saved: ${asset.file}`);
