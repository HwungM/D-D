...
const ASSETS = [
  ...
  { file: 'races/human.png', prompt: `${STYLE} A male human warrior with weathered face, a strong jaw, determined eyes, short dark hair with grey at the temples, battered leather armor. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/elf.png', prompt: `${STYLE} A male elf with warm skin, an extremely elongated narrow skull, dramatically high sharp cheekbones, a long straight nose, enormous upswept almond eyes of vivid violet, ears tapering to a very long exaggerated point — distinctly non-human bone structure, fine forest-green garb. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/dwarf.png', prompt: `${STYLE} A male dwarf warrior with a very wide broad skull, an extremely low heavy brow ridge, a wide flat nose, a square jaw nearly as wide as the skull, a magnificent thick braided beard wound with iron rings, hammered steel pauldrons. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/halfling.png', prompt: `${STYLE} A male halfling with a very round full skull with plump rounded cheeks, a small upturned nose, very large bright curious eyes set wide apart, curly hair, prominent rounded ears slightly larger than human, a patched traveling cloak. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/gnome.png', prompt: `${STYLE} A male gnome with an oversized domed forehead nearly twice the height of the lower face, enormous round eyes behind thick goggle lenses pushed up on his brow, a very small pointed chin, a large expressive nose, wild hair defying gravity, mechanical collar trinkets. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/half-orc.png', prompt: `${STYLE} A male half-orc with grey-green skin, a jutting underbite with two prominent upward-curving tusks, a very wide flat nose, a heavy protruding brow ridge, wide-set amber eyes, a powerful broad jaw, ritual scarring, iron-plated armor. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  ...
  // ── INTERIOR SCENES — BATCH 2 ─────────────────────────────────────────────
  { file: 'scenes/throne-room-corrupted.png', size: '1536x1024', prompt: `${SCENE_STYLE} A corrupted dark throne room, the stone throne cracked and overgrown with black thorned vines, dark ichor seeping from the walls, purple eldritch fire burning in iron sconces, a shattered stained-glass window casting fragmented light, utterly empty.` },
  { file: 'scenes/war-room.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty war planning room, a massive stone table covered in battle maps and wooden troop markers, candles burning low in iron holders, weapons and banners leaning against the walls, war documents scattered, no commanders present.` },
  { file: 'scenes/observatory.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty astronomical observatory at night, an enormous brass and copper orrery filling the center of the domed chamber, star charts pinned to the curving walls, a massive refracting telescope aimed at an opening in the dome revealing the night sky, no scholars present.` },
  { file: 'scenes/treasury.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty underground treasury vault, heavy iron door hanging open, shelves and chests of coins, gemstones, and golden objects in the flickering torchlight, cobwebs in the corners suggesting long abandonment, no figures present.` },
  { file: 'scenes/torture-chamber.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty stone torture chamber beneath a fortress, iron racks and chains hanging from the ceiling, a brazier of cold coals, implements on a stone table, water dripping from the walls, a single barred window letting in no light, utterly silent.` },
  { file: 'scenes/portal-chamber.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty arcane portal chamber, a massive stone archway filled with swirling dimensional energy in violet and gold, runes carved into the floor in a perfect circle around it, arcane machinery turning slowly, no travelers standing at the threshold.` },
  { file: 'scenes/underground-temple.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty underground temple carved from raw stone, a colossal idol of an alien god looming over a blood-stained altar, burning torches in carved niches, offerings of bones and dried flowers arranged on the steps, no cultists present.` },
  { file: 'scenes/mine-shaft.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty abandoned mine shaft, wooden support beams lining a descending tunnel, rusted ore carts on narrow rails, pickaxe marks on the walls, lanterns left burning at intervals going deeper into the earth, no miners present.` },
  { file: 'scenes/bell-tower.png', size: '1536x1024', prompt: `${SCENE_STYLE} The empty interior of a dark bell tower, a massive ancient bronze bell hanging still in the rafters, ropes trailing down into darkness, pigeons roosting above, grey light through narrow belfry slots, no ringers present.` },
  { file: 'scenes/dressing-room.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A crowded theatrical dressing room beneath a grand stage, costumes and masks hanging on every wall, makeup tables with mirrors surrounded by candles, anonymous costumed performers partially visible in the background going about preparation, no single figure singled out.` },
  { file: 'scenes/royal-bedchamber.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty royal bedchamber, a massive canopied four-poster bed with rich tapestry curtains, an unlit fireplace, a full-length mirror, a writing desk scattered with documents and broken seals, moonlight through tall narrow windows, utterly abandoned.` },
  { file: 'scenes/scriptorium.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty monastic scriptorium, rows of sloped writing desks with half-finished manuscripts and dried inkwells, quills laid down mid-page, shelves of leather rolls and bound books, a single shaft of cold morning light through a high narrow window, utterly silent.` },
  { file: 'scenes/cathedral-ruin.png', size: '1536x1024', prompt: `${SCENE_STYLE} The interior of a ruined cathedral, roof collapsed exposing the nave to a storm sky, rain coming in through shattered stained-glass windows, pews overturned, ivy reclaiming the stone columns, the altar still standing alone, no worshippers.` },
  { file: 'scenes/colosseum-underground.png', size: '1536x1024', prompt: `${SCENE_STYLE} The empty underground staging area beneath a colosseum, iron cages lining the walls, chains hanging from hooks, torchlight and the distant roar of a crowd echoing from above through a grate in the ceiling, sand and old blood on the floor, no gladiators.` },
  { file: 'scenes/thieves-vault.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty hidden thieves guild vault, shelves of stolen valuables, a central table with tools for cracking locks and forgery supplies, a trap door in the floor leading down, a coded job board on the wall, candles burning low, no one present.` },
  { file: 'scenes/shipwreck-hold.png', size: '1536x1024', prompt: `${SCENE_STYLE} The empty flooded hold of a sunken ship, murky green water at knee height, broken crates and barnacled cargo, daylight filtering eerily from above through a cracked hull, fish darting between the wreckage, no explorers present.` },
  { file: 'scenes/inn-upstairs.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty narrow upstairs corridor of a creaking inn, doors to rented rooms along both sides, a candle guttering in a wall sconce, thin rugs over warped floorboards, one door slightly ajar showing a rumpled bed within, utterly quiet.` },
  { file: 'scenes/greenhouse.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty overgrown greenhouse, glass panels clouded with moisture, exotic and dangerous-looking plants pressing against the glass, moss covering every surface, a central stone path barely visible under encroaching roots, no gardener present.` },
  { file: 'scenes/clockwork-workshop.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty clockwork artificer workshop, every surface covered in gears, springs, and mechanical components of varying scale, half-assembled clockwork constructs on workbenches, tools in neat rows, a massive gear-driven clock mechanism turning on one wall, no artificer present.` },
  { file: 'scenes/necromancer-sanctum.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty necromancer's sanctum, shelves of skulls and bone components, bubbling dark vials, a ritual circle of bones and ash on the stone floor, candles made of tallow that gutters green, hanging diagrams of anatomy and resurrection rituals, no necromancer present.` },
  { file: 'scenes/throne-antechamber.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A grand throne room antechamber, ornate but cold stone, anonymous courtiers and petitioners at a middle distance waiting along the walls, a pair of heavy doors leading onward, guards standing at attention with their backs turned, no single figure singled out.` },
  { file: 'scenes/catacombs.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty catacomb passage, skulls and femurs mortared into the walls in decorative patterns, stone archways receding into darkness, a single oil lamp hanging at a junction, the smell of old stone and ancient death implied, no living soul.` },
  { file: 'scenes/council-chamber.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A grand council chamber, long curved table with seats for many, anonymous robed advisors and scribes at a middle distance reviewing documents and in hushed conversation, banners of various houses on the walls, candlelight and ink, no single figure singled out.` },
  { file: 'scenes/study-private.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty private scholar's study, a heavy desk buried under papers and half-written manuscripts, shelves overflowing with books, a cold fireplace with a dying ember, a globe and celestial maps, a locked chest under the desk, signs of recent hasty departure.` },

  // ── OUTDOOR SCENES — BATCH 2 ─────────────────────────────────────────────
  { file: 'scenes/standing-stones-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} Empty ancient standing stones on a windswept moor by day, massive monoliths in a perfect circle, carved with worn runes, scrubby heather around their bases, brooding grey-white sky, crows circling overhead, no travelers present. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/standing-stones-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty ancient standing stones on a windswept moor at night, massive monoliths faintly glowing with dormant runes, a full moon behind thin racing clouds, mist pooling between the stones, no travelers present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/druid-circle-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty druid grove by day, ancient yew trees in a perfect ring around a mossy altar stone, wildflowers covering the ground, shafts of golden light between the trunks, birdsong implied in the stillness, no druids present. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/druid-circle-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty druid grove at night, the trees ringing a mossy altar stone, faint phosphorescent lichen on the bark, moonlight in the clearing, fireflies between the roots, no druids present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/coastal-village-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A small coastal fishing village by day, colorful boats beached on sand, nets hanging to dry, anonymous fishermen and villagers at a middle distance going about their work, whitewashed cottages on the hillside, seabirds wheeling, warm sea light, no single figure singled out. This is the daytime counterpart to an evening version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/coastal-village-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same small coastal fishing village at night, boats beached on dark sand, nets hanging still, cottage windows warm with candlelight, the sea a dark mirror under stars, utterly quiet, no one outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },

  { file: 'scenes/forest-shrine-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty woodland shrine by day, a carved stone figure of a nature god at the base of an ancient tree, offerings of flowers and carved tokens on a stone shelf, dappled sunlight through a forest canopy, vines adorning the statue, no worshippers. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/forest-shrine-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty woodland shrine at night, the carved stone figure lit by moonlight, small candles left by unknown hands flickering at its base, fireflies drifting, cool dark forest pressing in, no worshippers. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/glacier-field-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty glacier field by day, endless blue-white ice stretching to the horizon, deep crevasses cutting through the surface, wind-sculpted ridges, a pale sun barely warming the air, no explorers present. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/glacier-field-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty glacier field at night, the ice glowing with trapped cold light under a star-thick sky, the aurora borealis reflecting in the ice planes, deep shadows in the crevasses, no explorers present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/haunted-manor-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty abandoned manor house exterior by day, a grand but decaying three-story building, shattered windows, overgrown gardens, iron gates hanging open, crows on the broken eaves, an overcast oppressive sky, no figures. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/haunted-manor-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty abandoned manor house exterior at night, one upper window flickering with impossible candlelight, iron gates hanging open, overgrown gardens in deep shadow, a full moon behind racing clouds, no figures outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/crossroads-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty rural crossroads by day, four dirt roads meeting under a weathered signpost, a gibbet hanging empty at the corner, crows on the post, rolling countryside in every direction, no travelers at the junction. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/crossroads-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty rural crossroads at night, the signpost silver in moonlight, the gibbet casting a long shadow, crows silent on the beam, the four roads vanishing into darkness, no travelers present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/lighthouse-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty lighthouse on a rocky sea promontory by day, white tower against a grey sky, waves crashing on the rocks below, the light dark at this hour, seabirds nesting on the rocks, no keeper visible. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/lighthouse-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty lighthouse at night, the great beam sweeping out over a dark churning ocean, rocks below slick with spray in moonlight, no keeper visible on the gallery. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/underground-river-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty underground river in a vast cave, black water moving silently between stone banks, stalactites reflected in the surface, bioluminescent algae on the walls giving a faint blue glow, a stone dock with a moored flat-bottomed boat, no travelers.` },

  { file: 'scenes/frozen-tundra-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} Empty frozen tundra stretching to the horizon by day, scrubby frost-killed bushes under a flat white sky, a cracked frozen lake, a single dead tree leaning in permafrost, no travelers. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/frozen-tundra-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty frozen tundra at night, the ice lit by the aurora in cold greens and purples, the frozen lake a dark mirror, utterly still and silent, no travelers. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/moonlit-lake-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty moonlit forest lake at night, perfectly still black water reflecting a full moon, ancient willows trailing branches at the shore, mist drifting low over the water, fireflies at the treeline, no one present.` },
  { file: 'scenes/mountain-lake-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty alpine mountain lake by day, impossibly clear turquoise water in a bowl of grey granite peaks, snowfields on the summits, wildflowers on the near shore, no travelers. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/mountain-lake-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty alpine mountain lake at night, the turquoise water dark and still, peaks silhouetted against a star-filled sky, the Milky Way reflected in the glassy surface, no travelers. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/windmill-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty countryside windmill by day, white stone tower with large wooden sails turning slowly in the wind, golden wheat fields surrounding it, a blue sky with fat clouds, no miller visible. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/windmill-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty countryside windmill at night, stone sails still, wheat fields pale under a rising moon, warm window-light from within, no miller visible outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/cliffside-monastery-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty cliffside monastery carved into the face of a sheer mountain, stone terraces and walkways cut into the rock, prayer flags strung between spires, vast mountain vista below, pale morning sky, no monks visible. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/cliffside-monastery-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty cliffside monastery at night, lanterns burning in the carved windows, prayer flags limp in the cold air, stars above the mountain peaks, no monks visible. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/underground-city-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A vast underground city carved into cavern walls, anonymous figures at a middle distance moving along narrow bridges and stairways, buildings stacked on every level of the stone walls lit by glowing crystals, a central underground square below, no single figure singled out.` },

  { file: 'scenes/wizard-tower-exterior-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty wizard tower exterior by day, a tall impossibly slender stone spire with arcane runes carved on every surface, windows glowing with arcane light even in daylight, a floating bookshelf visible through one window, surrounding landscape of forest and low hills, no travelers. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/wizard-tower-exterior-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty wizard tower exterior at night, arcane runes pulsing faintly, windows blazing violet-gold against the dark sky, lightning crackling from the summit, stars above, no travelers. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/dark-cathedral-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} The empty exterior of a dark gothic cathedral by day, black stone spires piercing an overcast sky, gargoyles on every parapet, a massive rose window with dark stained glass, iron gates at the entrance standing closed, crows everywhere, no visitors. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/dark-cathedral-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty dark gothic cathedral exterior at night, black spires against a stormy sky, the rose window lit eerie red from within, gargoyles gleaming in rain, iron gates hanging open, no visitors. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/dwarven-hall-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A vast dwarven underground hall by lantern-light, enormous carved stone pillars, anonymous dwarven workers and craftspeople at a middle distance going about their labor, a ceiling lost in shadow above, forge-fires glowing in alcoves along the walls, no single figure singled out.` },

  { file: 'scenes/elven-city-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A beautiful elven city built among towering ancient trees by day, graceful white-stone bridges between the trunks at height, anonymous elves at a middle distance moving through dappled light, flowering vines on every surface, birdsong implied, no single figure singled out. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/elven-city-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same elven city at night, the great trees dark, lanterns of captured starlight along the bridges, a deep quiet, the distant sound of music implied, no figures visible. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },

  { file: 'scenes/cursed-forest-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty cursed dead forest by day, black leafless trees with twisted branches like grasping hands, grey ashy ground, an unnatural silence, no wildlife, a pale sickly sun that gives no warmth, something deeply wrong in the air, no travelers present. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/cursed-forest-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty cursed dead forest at night, black trees silhouetted against a putrid yellow moon, faint will-o'-wisps drifting between the trunks, the ground covered in grey ash, no wildlife, no travelers present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/astral-plane.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty astral plane, infinite silver-grey void with drifting geometric islands of crumbled stone, distant planetary bodies and impossible architecture half-visible in a void lit by its own faint silver light, no travelers present. Wide cinematic framing.` },
  { file: 'scenes/shadow-realm.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty shadow realm, a dark mirror of the material world in deep purples and blacks, twisted inverted architecture, negative-light shadows that glow instead of darken, a cold silent wrongness to everything, no figures present. Wide cinematic framing.` },
  { file: 'scenes/elemental-plane-fire.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty Elemental Plane of Fire, a vast landscape of flowing lava rivers and magma islands, fire tornadoes in the distance, the entire sky a roof of flame, superheated air distorting everything, no figures present. Wide cinematic framing.` },
  { file: 'scenes/elemental-plane-water.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty Elemental Plane of Water, a sunless underwater world of impossible scale, colossal coral structures and kelp forests reaching into infinite depth, light diffusing from somewhere above, no surface visible, no explorers present. Wide cinematic framing.` },
  { file: 'scenes/abyss.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty layer of the Abyss, a vast rocky demon-landscape of black stone under a sky of dying red, obsidian fortresses on distant cliffs, rivers of dark fire, the smell of sulfur and despair implied, utterly empty of visible demons. Wide cinematic framing.` },
  { file: 'scenes/nine-hells.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty layer of the Nine Hells, a bureaucratic hellscape of oppressive iron architecture stretching to the horizon under a smoldering orange sky, chains and contracts embedded in the walls, cold clinical order imposed on a landscape of suffering, no devils visible. Wide cinematic framing.` },
  { file: 'scenes/celestial-realm.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty celestial realm, a gleaming landscape of white and gold stone, waterfalls of pure light, clouds below a plane that has no sky ceiling, warmth and radiance in every surface, a serenity almost oppressive, no celestials visible. Wide cinematic framing.` },
  { file: 'scenes/feywild-court.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty Feywild court, a grand throne room made entirely of living wood and woven vines, blossoms opening and closing on their own, impossible colors in the stained thorn-glass windows, the air thick with glamour, no fey present.` },

  { file: 'scenes/tundra-village-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A hardy tundra village by day, low sod-roofed buildings half-buried in drifts, anonymous figures in heavy furs at a middle distance moving between the structures, a central bonfire smoldering, reindeer hides stretched on frames, grey-white sky, no single figure singled out. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/tundra-village-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same hardy tundra village at night, sod buildings buried in snow, a bonfire crackling at the center, warm window-glow from within, the aurora overhead, no figures outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },

  { file: 'scenes/pirate-cove-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A hidden pirate cove by day, a natural rock harbour with a ship moored inside, anonymous pirates at a middle distance unloading cargo and moving around the rocky beach, palm trees and cave openings in the cliffs, no single figure singled out. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/pirate-cove-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same hidden pirate cove at night, the moored ship dark, bonfires on the beach, lanterns on the rigging, the cove hidden in deep shadow, no figures visible. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },

  { file: 'scenes/oracle-cave.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty oracle's cave, a natural cavern where a deep still pool reflects no sky, cryptic messages carved into every surface by many different hands, burning censers of aromatic smoke, offerings of coins and tokens around the pool, no petitioners or oracle present.` },

  { file: 'scenes/mountain-fortress-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty mountain fortress exterior by day, massive black stone walls built directly into the cliff face, iron-reinforced gates, a flag snapping in the alpine wind, sheer drops on three sides, grey overcast sky, no guards visible. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/mountain-fortress-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty mountain fortress at night, torches burning in iron brackets on the walls, the cliff face dropping into darkness below, clouds racing past the battlements, no guards visible. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/ancient-library-ruin-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} Empty ruins of an ancient great library by day, collapsed shelves and rotted scrolls, columns still standing above a rubble floor, vines through the broken ceiling, dust and bird droppings on everything, no explorers present. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/ancient-library-ruin-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty ancient library ruins at night, moonlight through the broken ceiling, glinting off fragments of gilded text still on collapsed shelves, an oppressive silence, no explorers present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/dockside-alley-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} A narrow empty dockside alley by day, salt-stained stone walls, barrels and crates, ropes coiled on hooks, a sliver of harbor visible at one end, gulls overhead, no figures lurking. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/dockside-alley-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same narrow dockside alley at night, a single lantern casting a puddle of orange light, shadows thick on either side, barrels and crates looming dark, the harbor at one end a strip of black water, no figures lurking. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/sunken-city.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty sunken city on the seafloor, ancient towers still standing though coated in coral and kelp, roads of sunken cobblestone, fish drifting between the buildings, light filtering green from the surface far above, no explorers present. Wide cinematic framing.` },

  { file: 'scenes/desert-ruins-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} Empty desert ruins by day, massive sandstone columns half-buried in dunes, carved facades emerging from the sand, sun-bleached and wind-scoured, a blazing sun overhead, no explorers. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/desert-ruins-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty desert ruins at night, sandstone columns silver in moonlight, deep shadows between the stones, a cool clear sky brilliant with stars, no explorers. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/vampire-castle-day.png', size: '1536x1024', prompt: `${SCENE_STYLE} An empty vampire castle exterior by day, a gaunt black fortress on a crag above a dead forest, bats roosting in the eaves even by day, iron-barred windows, no sunlight seeming to warm the stone, grey sky, no figures. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and sky.` },
  { file: 'scenes/vampire-castle-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same empty vampire castle at night, black spires against a full moon, bats swarming from the towers, a few windows lit with dim unhealthy light, fog rising from the dead forest below, no figures outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and sky.` },

  { file: 'scenes/market-alley-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A narrow covered market alley by day, low archways strung with lanterns and hanging goods, anonymous merchants and buyers at a middle distance moving past stalls of cloth and spices, cobblestones slick with produce drips, no single figure singled out. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/market-alley-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same narrow covered market alley at night, most stalls shuttered, a few lanterns still burning, cobblestones wet and empty, shadows deep in the archways, no figures present. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },

  { file: 'scenes/snowy-village-day.png', size: '1536x1024', prompt: `${SCENE_STYLE_LIVED_IN} A snow-covered mountain village by day, stone cottages with thick snow on the rooftops, anonymous bundled-up villagers at a middle distance going about winter tasks, a frozen well at center, smoke from chimneys, pale winter light, no single figure singled out. This is the daytime counterpart to a night version — keep the composition identical, changing only the light and activity.` },
  { file: 'scenes/snowy-village-night.png', size: '1536x1024', prompt: `${SCENE_STYLE} The same snow-covered mountain village at night, rooftops buried under snow, warm candlelight in the windows, a frozen well at center, snowflakes drifting, utterly quiet, no figures outside. This is the nighttime counterpart to a daytime version — keep the composition identical, changing only the light and activity.` },
...
const RACE_FLAVOR = {
  human: 'deep brown skin with warm undertones, a broad strong jaw with slight asymmetry, wide flat nose with broad nostrils, weathered crow feet at deep-set dark brown eyes under a heavy brow, short natural black hair with grey at the temples, battered leather armor — looks like someone who has actually lived',
  elf: 'warm light-brown skin, an extremely elongated narrow skull, dramatically high sharp cheekbones, a long straight nose, enormous upswept almond eyes of vivid violet, ears that taper to a very long exaggerated point, angular jaw with almost no curve — distinctly non-human bone structure, fine forest-green garb',
  dwarf: 'warm tan skin with ruddy undertones, a very wide broad skull, an extremely low heavy brow ridge, a very wide flat nose with broad nostrils, a square jaw nearly as wide as the skull, deep-set dark eyes, a magnificent thick braided dark beard wound with iron rings, hammered steel pauldrons',
  halfling: 'warm light-brown skin, a very round full skull with plump rounded cheeks, a small wide upturned nose, very large bright green eyes set wide apart, short tight-coiled black hair, prominent rounded ears slightly larger than human, small dimpled chin — genuine not cute-idealized',
  gnome: 'warm olive skin, an oversized domed forehead nearly twice the height of the lower face, enormous round amber eyes behind thick goggle lenses pushed up on the brow, a very small pointed chin, a large expressive bulbous nose, wild salt-and-pepper hair defying gravity, mechanical collar trinkets',
  ...
  'fire-genasi': 'East Asian facial structure — high flat cheekbones, slightly wider face, epicanthic fold at the eyes — but the skin is ember-red and cracked at the cheekbones and brow with lines of deep orange magma-light beneath, no hair replaced by living flame rising from the scalp, eyebrows of flame, solid amber-orange eyes with no white',
  'water-genasi': 'Hispanic or Latin American facial structure — warm rounded cheekbones, full lips, expressive eyes — but the skin is deep teal-blue with a subtle wet sheen, flowing dark blue hair that moves as if permanently submerged, entirely solid turquoise eyes with no white or pupil, small fin-like gill crests at the temples',
  'earth-genasi': 'skin that is literally cracked grey stone with dark mineral veins running through it, hair replaced by jutting jagged obsidian crystal shards growing from the scalp, eyes that are smooth polished amber gemstones with no pupil, a very broad flat nose, a heavy square jaw of stone — the underlying bone structure broad and strong',
  'air-genasi': 'Central Asian or Slavic facial structure — strong brow, defined cheekbones, a slightly wider nose — but the skin is pale silver-white like fresh snow or polished bone, not European-pink but cool and luminous, silver-white hair that perpetually floats and drifts as if in a wind, pale silver-blue eyes with no pupil',
  goliath: 'deep blue-grey stone-patterned skin with bold black tribal markings, an extremely massive skull, a very wide flat nose, deep-set small pale eyes under a prominent brow shelf, a jaw wider than most humans shoulders, bald, the sheer scale making features seem compressed',
  firbolg: 'soft grey-lavender skin with a broad gentle face, a very large round head with a broad flat bovine-like face, a very wide flat nose with large nostrils, large floppy rounded ears set low, small gentle pale blue eyes, a wide kind mouth — robes hung with herbs',
  changeling: 'a face that is genuinely uncanny — no defined ethnicity, no defined race, smooth skin with absolutely no pores, freckles, or texture, features that are slightly too centered and too even, a nose that is barely a nose — just a subtle rise with two small nostrils, lips that are present but thin and expressionless, enormous flat silver-white eyes with no iris or pupil distinction, the face slightly too wide and too flat like a mask that is almost human, white-grey hair with no warmth to it, the overall effect of something that learned to have a face rather than being born with one',
  ...
  harengon: 'a rabbit head with warm tawny fur — long upright mobile ears, a small twitching round nose, very large warm brown eyes set slightly to the sides, soft fur covering the entire face, a small mouth, alert compact posture',
  'yuan-ti': 'South Asian or Southeast Asian facial structure — warm light olive-tan skin with a faint iridescent green-gold scale shimmer at the temples, cheekbones, and jaw, slit-pupil golden eyes, a slightly too-wide jaw, faint overlapping scale patterns along the hairline and neck, a tongue subtly forked when the mouth opens, cold aristocratic stillness, silky dark hair',
  triton: 'deep teal-blue skin — dark and saturated not pale, small elegant fin-like crests at the temples, entirely solid deep oceanic blue eyes with no white, a broad wide nose, high cheekbones, hair like dark kelp tendrils, scaled shoulder armor',
  ...
  hobgoblin: 'dark reddish-brown skin, a broad flat nose, wide-set dark disciplined eyes under a pronounced brow ridge, prominent lower jaw with small lower tusks, slightly pointed ears, military bearing, functional armor with unit insignia — a face built for war not beauty',
