...
const ASSETS = [
  ...
  { file: 'races/human.png', prompt: `${STYLE} A male human warrior with deep brown skin, a strong square jaw, weathered face, crow's-feet at the eyes, determined dark eyes under a heavy brow, short black hair with grey at the temples, battered but well-kept leather armor, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/elf.png', prompt: `${STYLE} A male elf with warm olive-tan skin, an extremely elongated narrow skull, dramatically high sharp cheekbones, a long straight nose, enormous upswept almond eyes of vivid violet, ears that taper to a very long exaggerated point, a long angular jaw — distinctly non-human bone structure, fine forest-green garb, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/dwarf.png', prompt: `${STYLE} A male dwarf warrior with ruddy copper-tan skin, a very wide broad skull, an extremely low heavy brow ridge, a wide flat nose, a square jaw nearly as wide as the skull, a magnificent thick braided red beard wound with iron rings, deep-set grey eyes, hammered steel pauldrons, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/halfling.png', prompt: `${STYLE} A male halfling with warm brown skin, a very round full skull with plump rounded cheeks, a small upturned button nose, very large bright green eyes set wide apart, short curly black hair, prominent rounded ears slightly larger than human, a small dimpled chin, a patched traveling cloak, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/gnome.png', prompt: `${STYLE} A male gnome with pale olive skin, an oversized domed forehead nearly twice the height of the lower face, enormous round amber eyes behind thick goggle lenses pushed up on his brow, a very small pointed chin, a large cartoonishly expressive nose, wild white hair defying gravity, mechanical collar trinkets, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/half-orc.png', prompt: `${STYLE} A male half-orc with vivid grey-green skin, a jutting underbite with two prominent upward-curving tusks, a very wide flat nose with flared nostrils, a heavy protruding brow ridge, wide-set amber eyes under thick brows, a powerful broad jaw, ritual scarring across the brow and cheeks, iron-plated armor, a calm, composed, neutral expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
  { file: 'races/tiefling.png', prompt: `${STYLE} A male tiefling with vivid deep crimson skin, two prominent smooth curving black horns rising from the forehead, entirely solid gold irises with no pupil or white, sharp angular cheekbones, a slightly too-wide jaw, subtly pointed teeth visible in a neutral expression, dark arcane robes. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing. This is a male character — strong jaw, angular male face structure.` },
  { file: 'races/dragonborn.png', prompt: `${STYLE} A male dragonborn with overlapping bronze-gold scales instead of skin, a fully reptilian head — no hair, a flat broad snout with visible nostrils, rigid bony brow ridges, amber slit-pupil eyes set wide on the skull, a long neck, horns swept back from the crown, ornate scaled armor, a calm composed expression. ${RACE_BACKGROUND} Head-and-shoulders, facing the viewer, character-select-screen framing.` },
...
const RACE_FLAVOR = {
  ...
  tiefling: 'vivid deep crimson skin, two prominent smooth curving black horns rising clearly from the forehead — unmistakably demonic, not decorative, entirely solid gold irises with absolutely no pupil or white visible, sharp angular cheekbones, a slightly too-wide jaw, subtly pointed teeth just visible, a spaded tail tip visible at the shoulder edge, dark arcane robes — the face is striking and inhuman, not conventionally pretty',
  ...
  aasimar: 'golden-hued skin that faintly radiates light like an ember — not glowing, just slightly too warm, silver-white hair, irises that are a single solid sheet of luminous white-gold with no pupil, the whites of the eyes also faintly glowing, a high smooth brow, the face slightly too symmetrical and slightly too still — beautiful in an unnerving inhuman way that reads as other, not just pretty, a subtle halo-light visible at the hairline',
