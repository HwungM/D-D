...
const RACE_DIVERSITY = 'Natural imperfect features — not a model, not idealized, not conventionally beautiful. Asymmetric lived-in face. Do NOT default to white European features or light skin.';
...
const RACE_FLAVOR = {
  human: 'deep brown skin with warm undertones, West African or South Asian features, a broad strong jaw with slight asymmetry, wide flat nose with broad nostrils, weathered crow feet at deep-set dark brown eyes under a heavy brow, short natural black hair with grey at the temples, battered leather armor — looks like someone who has actually lived',
  elf: 'warm light-brown skin, East Asian or Southeast Asian bone structure, an extremely elongated narrow skull, dramatically high sharp cheekbones, a long straight nose, enormous upswept almond eyes of vivid violet, ears that taper to a very long exaggerated point, angular jaw with almost no curve — distinctly non-human bone structure, fine forest-green garb',
  dwarf: 'warm tan skin with ruddy undertones, Middle Eastern or South Asian features, a very wide broad skull, an extremely low heavy brow ridge, a very wide flat nose with broad nostrils, a square jaw nearly as wide as the skull, deep-set dark eyes, a magnificent thick braided dark beard wound with iron rings, hammered steel pauldrons',
  halfling: 'warm light-brown skin, Southeast Asian or Latin American features, a very round full skull with plump rounded cheeks, a small wide upturned nose, very large bright green eyes set wide apart, short tight-coiled black hair, prominent rounded ears slightly larger than human, small dimpled chin — genuine not cute-idealized',
  gnome: 'warm olive skin, East Asian or South Asian features, an oversized domed forehead nearly twice the height of the lower face, enormous round amber eyes behind thick goggle lenses pushed up on the brow, a very small pointed chin, a large expressive bulbous nose, wild salt-and-pepper hair defying gravity, mechanical collar trinkets',
  ...
  goliath: 'deep blue-grey stone-patterned skin with bold black tribal markings, Indigenous or East African-influenced broad features, an extremely massive skull, a very wide flat nose, deep-set small pale eyes under a prominent brow shelf, a jaw wider than most humans shoulders, bald, the sheer scale making features seem compressed',
  firbolg: 'soft grey-lavender skin with broad South Asian or Indigenous-influenced features, a very large round head with a broad flat bovine-like face, a very wide flat nose with large nostrils, large floppy rounded ears set low, small gentle pale blue eyes, a wide kind mouth — robes hung with herbs',
  ...
  harengon: 'a rabbit head with warm tawny-brown fur — long upright mobile ears, a small twitching round nose, very large warm brown eyes set slightly to the sides, soft fur covering the entire face, a small mouth, alert compact posture',
  'yuan-ti': 'warm brown skin with South Asian or Southeast Asian features and deeply unsettling reptilian intrusions — faint overlapping scale patterns at the temples and along the jaw, slit-pupil golden eyes, a slightly too-wide jaw, a tongue subtly forked when the mouth opens, an aristocratic stillness that never blinks at the right time',
  triton: 'deep teal-blue skin over Southeast Asian bone structure — dark and saturated not pale, small elegant fin-like crests at the temples, entirely solid deep oceanic blue eyes with no white, a broad wide nose, high cheekbones, hair like dark kelp tendrils, scaled shoulder armor',
  ...
  hobgoblin: 'dark reddish-brown skin with East Asian-influenced bone structure, a broad flat nose, wide-set dark disciplined eyes under a pronounced brow ridge, prominent lower jaw with small lower tusks, slightly pointed ears, military bearing, functional armor with unit insignia — a face built for war not beauty',
