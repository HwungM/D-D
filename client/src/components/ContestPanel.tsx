  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-3 mb-2.5">
        <span className="font-fantasy text-xs uppercase tracking-[0.16em]" style={{ color: 'rgba(206,193,255,0.92)' }}>
          {typeLabel}
        </span>
        <span className="font-serif text-xs italic truncate" style={{ color: 'rgba(191,244,255,0.72)' }}>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <div className="mb-1 flex justify-between">
            <span className="font-fantasy text-[9px] uppercase tracking-[0.18em]" style={{ color: 'rgba(167,243,208,0.8)' }}>Successes</span>
            <span className="font-serif text-xs" style={{ color: 'rgba(167,243,208,0.92)' }}>
              {skillChallenge.successes}/{skillChallenge.targetSuccesses}
            </span>
          </div>
          <div className="h-1.5 overflow-hidden border border-white/15 bg-black/44">
        ...
        <div>
          <div className="mb-1 flex justify-between">
            <span className="font-fantasy text-[9px] uppercase tracking-[0.18em]" style={{ color: 'rgba(252,165,165,0.8)' }}>Failures</span>
            <span className="font-serif text-xs" style={{ color: 'rgba(252,165,165,0.92)' }}>
      ...
      {(skillChallenge.stakesDescription || skillChallenge.stakes) && (
        <p className="mt-2.5 pt-2.5 font-serif text-xs leading-relaxed" style={{ color: 'rgba(220,205,250,0.68)', borderTop: '1px solid rgba(167,139,250,0.14)' }}>
